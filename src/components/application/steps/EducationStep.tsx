  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <select
          {...register('education.tertiaryEducation')}
          className="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 
            shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
        >
          <option value="none">None</option>
        ...
        {errors.education?.tertiaryEducation && (
          <p className="mt-1 text-sm text-red-600 dark:text-red-400">
            {errors.education.tertiaryEducation.message}
          </p>
        )}
      </div>
          ...
          {[0, 1, 2].map((index) => (
            <div key={index} className="grid gap-4 md:grid-cols-3">
              <div>
                ...
                <input
                  type="text"
                  {...register(`education.certificates.${index}.type`)}
                  className="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 
                    shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
                />
              </div>
              <div>
                ...
                <input
                  type="text"
                  {...register(`education.certificates.${index}.grade`)}
                  className="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 
                    shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
                />
              </div>
              <div>
                ...
                <input
                  type="text"
                  {...register(`education.certificates.${index}.year`)}
                  className="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 
                    shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
                />
              </div>
